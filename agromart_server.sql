-- =============================================================================
-- AgroHands AI / Agromart - Final server database
-- Run once: phpMyAdmin → Import this file, or: mysql -u root -p < agromart_server.sql
-- Default admin: admin@agromart.com / admin123
-- =============================================================================
...
SELECT u.id, 'Admin Shop', '', '' FROM users u
WHERE u.email = 'admin@agromart.com'
AND NOT EXISTS (SELECT 1 FROM shops s WHERE s.owner_id = u.id)
LIMIT 1;

-- =============================================================================
-- Default login: admin@agromart.com / admin123
-- =============================================================================
